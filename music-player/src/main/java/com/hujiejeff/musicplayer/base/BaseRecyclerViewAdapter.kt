...
abstract class BaseRecyclerViewAdapter<V: ViewBinding, D>(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder<V> {
        val clazz = getSuperClassGenericClass<V>(this)
        val inflateMethod = clazz.getDeclaredMethod("inflate",
            LayoutInflater::class.java,
            ViewGroup::class.java,
            Boolean::class.java)
        val binding: V = inflateMethod.invoke(null, LayoutInflater.from(context), parent, false) as V
